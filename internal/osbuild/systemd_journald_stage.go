...
func (o SystemdJournaldStageOptions) validate() error {
	...
	if o.Config.Journal.Storage == "" && o.Config.Journal.Compress == "" && o.Config.Journal.SplitMode == "" && o.Config.Journal.MaxFileSec == "" && o.Config.Journal.MaxRetentionSec == "" && o.Config.Journal.SyncIntervalSec == 0 && o.Config.Journal.Audit == "" {
